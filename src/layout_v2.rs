...
use crate::monitor_v2::{MonitorInfo, MonitorMap};
...
// Per-source config keyed by source
        ...
        let config = LiveWallpaperConfig {
            ...
            monitors: vec![
                MonitorConfig::Primary {
                    ...
                    source_type: SourceType::Filepath,
                    source: "/videos/test.mp4".into(),
                },
                MonitorConfig::Primary {
                    monitor: "DP-2".into(),
                    wallpaper_type: WallpaperType::Web,
                    source_type: SourceType::Uri,
